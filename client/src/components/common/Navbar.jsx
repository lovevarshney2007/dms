        ...
        <div className="mx-auto flex w-full max-w-7xl flex-nowrap items-center justify-between gap-2 md:gap-4 px-4 py-3 md:px-6 md:py-4">
          ...
          <Link to="/" className="relative flex items-center gap-2 md:gap-3 shrink-0">
            ...
            <div className="flex flex-col shrink-0">
              ...
              <p className="text-[10px] md:text-sm text-stone-600 leading-tight whitespace-nowrap">Musical Society</p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 mt-4 md:mt-0 md:ml-2 pt-4 md:pt-0 border-t md:border-none border-stone-200">
              <Link to="/register" onClick={() => setMenuOpen(false)} className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-5 py-3 md:py-2.5 rounded-full hover:shadow-[0_4px_15px_rgba(234,88,12,0.3)] hover:-translate-y-0.5 text-[15px] font-bold transition-all text-center">
                Register
              </Link>
            </div>
          </nav>
