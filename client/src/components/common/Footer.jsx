        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 mb-10">
          ...
          <div className="md:col-span-12 lg:col-span-5">
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              <a href="https://www.instagram.com/dmsaarohi/" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-full bg-stone-900 border border-stone-800 flex items-center justify-center text-[#E1306C] hover:bg-[#E1306C] hover:text-white hover:border-[#E1306C] transition-all duration-300" aria-label="Instagram">
          ...
          <div className="md:col-span-6 lg:col-span-4 lg:justify-self-end">
            ...
            <ul className="space-y-4 text-sm font-semibold">
              <li className="flex items-start gap-3">
                ...
                <span className="text-stone-300 leading-snug">Paschim Vihar, Delhi</span>
              </li>
