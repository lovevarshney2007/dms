...
const MagneticButton = ({ children, className, variant = 'primary', href, ...props }) => {
  ...
  const baseClasses = "relative overflow-hidden font-bold rounded-full px-6 sm:px-8 py-3 sm:py-4 transition-all duration-500 flex items-center justify-center group w-full sm:w-auto text-sm sm:text-base";
  const variants = {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative overflow-hidden mb-4 sm:mb-6 py-2">
          <h1 className="text-[42px] sm:text-[72px] md:text-[96px] lg:text-[110px] font-[800] leading-[1.1] sm:leading-[1.05] tracking-tighter bg-gradient-to-b from-white via-[#d8d8d8] to-white bg-clip-text text-transparent drop-shadow-sm px-2">
            DMS Aarohi
          </h1>
          {/* Shine Effect */}
          <motion.div
        ...
        <div className="text-[22px] sm:text-[36px] md:text-[48px] font-bold text-white/90 mb-6 sm:mb-10 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 h-auto sm:h-[60px]">
          ...
          <div className="relative w-[180px] sm:w-[280px] md:w-[320px] h-[35px] sm:h-[50px] md:h-[60px] overflow-hidden text-center sm:text-left flex items-center justify-center sm:justify-start">
        ...
        <motion.p 
          ...
          className="text-white/60 text-base sm:text-lg md:text-xl font-medium leading-relaxed max-w-[700px] mb-8 sm:mb-12 px-2"
        >
