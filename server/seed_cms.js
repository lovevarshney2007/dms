...
// Dummy Data
const pastShows = [
  { type: "competition", title: "100 Years of Indian Cinema", subtitle: "1st Show of DMS Aarohi", description: "The very first show of DMS Aarohi. The Indian Cinema has undergone a massive change over the years. It started in 1913 from silent movies to the first talkie in 1931 to the colored movies to the ones today.", imageUrl: "/legacy/100Years.jpg", year: "2013", order: 1 },
  ...
  { type: "competition", title: "Ek Haseen Shaam Ko", subtitle: "2nd Show — Rafi Tribute", description: "2nd show of DMS AAROHI on Mohd. Rafi. He was an Indian playback singer & one of the most popular & successful singers of the Hindi film industry.", imageUrl: "/images/ekHaseenShaam.jpg", year: "2013", order: 3 },
  ...
  { type: "competition", title: "Bollywood Dhamaka", subtitle: "Amphitheatre Special", description: "An electrifying evening of high-energy Bollywood performances by our rising stars. The open-air setting added to the magical experience.", imageUrl: "/images/bollywoodDhamaka.jpg", year: "2015", order: 6 },
