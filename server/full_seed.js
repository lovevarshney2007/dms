...
const pastShows = [
  { type: "competition", title: "100 Years of Indian Cinema", subtitle: "1st Show of DMS Aarohi", imageUrl: "/images/100Years.jpg", order: 1, meta: { date: "2013", location: "India Islamic Cultural Centre, New Delhi", description: "The very first show of DMS Aarohi. The Indian Cinema has undergone a massive change over the years. It started in 1913 from silent movies to the first talkie in 1931 to the colored movies to the ones today.", tag: "Cultural Event" } },
  ...
  { type: "competition", title: "Ek Haseen Shaam Ko", subtitle: "2nd Show - Rafi Tribute", imageUrl: "/images/ekHaseenShaam.jpg", order: 3, meta: { date: "2013", location: "India Islamic Cultural Centre, New Delhi", description: "2nd show of DMS AAROHI on Mohd. Rafi. He was an Indian playback singer & one of the most popular & successful singers of the Hindi film industry.", tag: "Tribute Concert" } },
  { type: "competition", title: "Members Show", subtitle: "Open Air Theatre", imageUrl: "/images/img301.jpg", order: 4, meta: { date: "2014", location: "Open Theatre, Dilli Haat, INA, New Delhi", description: "The Musical Evening was enjoyed by all and provided a great platform for the members to engage with the students and encourage them in their endeavors.", tag: "Musical Evening" } },
  { type: "competition", title: "A Tribute to Mohammad Rafi", subtitle: "Legends Live On", imageUrl: "/images/img701.jpg", order: 5, meta: { date: "2014", location: "Pearey Lal Bhawan, New Delhi", description: "Another magical evening dedicated to the legendary Mohammad Rafi, featuring classic hits from the golden era of Bollywood.", tag: "Tribute Concert" } },
  { type: "competition", title: "Dostana-2 - Kishore Kumar Tribute", subtitle: "A Night of Melodies", imageUrl: "/images/krm.jpg", order: 6, meta: { date: "4th August, 2018", location: "India Islamic Cultural Centre, New Delhi", description: "Celebrating the versatility and genius of Kishore Kumar, our talented singers brought his evergreen songs back to life.", tag: "Tribute Concert" } },
  { type: "competition", title: "Bollywood Dhamaka", subtitle: "Blockbuster Hits", imageUrl: "/images/img12.jpg", order: 7, meta: { date: "2015", location: "Amphitheatre, Gurgaon", description: "A high-energy show featuring the biggest Bollywood chartbusters from the 90s to the present, getting the audience on their feet.", tag: "Musical Extravaganza" } }
];
